...
import com.example.finova.ui.theme.FinovaNavy
...
fun BottomNavigationBar(navController: NavController) {
    ...
    NavigationBar(
        containerColor = FinovaNavy.copy(alpha = 0.8f),
        ...
        items.forEach { screen ->
            NavigationBarItem(
                ...
                colors = NavigationBarItemDefaults.colors(
                    selectedIconColor = FinovaGold,
                    unselectedIconColor = Color.Gray,
                    selectedTextColor = FinovaGold,
                    unselectedTextColor = Color.Gray,
                    indicatorColor = FinovaNavy.copy(alpha = 0.5f)
                )
            )
        }
    }
