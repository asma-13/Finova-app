...
import com.example.finova.viewmodels.AddTransactionViewModel

@Composable
fun AddTransactionScreen(navController: NavController, viewModel: AddTransactionViewModel = viewModel()) {
    ...
    Surface(color = FinovaMaroon, modifier = Modifier.fillMaxSize()) {
        Column(
            ...
            Text("Add a New Transaction", style = MaterialTheme.typography.headlineMedium)
